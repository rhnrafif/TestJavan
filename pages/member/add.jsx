...
export default function Add(){
    ...
    const submitForm = async(e)=>{
        try{
            ...
            axios.post("https://family-asset.vercel.app/api/member/add", request)
            .then((res)=>{
                if(res.status === 201){
                    setIsLoading(!isLoading)
                    router.push('/member')
        ...
        <>
            <main className='min-w-full min-h-screen bg-gray-900 ' >
                <div className="container relative min-h-screen flex flex-col justify-center items-center max-w-lg mx-auto bg-slate-100">
                    ...
                    <div className="relative w-[360px] h-[220px] p-4 rounded-lg flex flex-col gap-4 justify-around items-center bg-gray-900 mx-auto">
