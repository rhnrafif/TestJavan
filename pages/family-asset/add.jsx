    ...
    const submitForm = async(e)=>{
        try{            
            ...
            .then(async(res)=>{
                ...
                await axios.get(`https://family-asset.vercel.app/api/member/add-member/${e.name}`).then(()=>{})
                await axios.get(`https://family-asset.vercel.app/api/asset-records/add-asset/${e.asset}`).then(()=>{})
